...
import { ipcRenderer, contextBridge, createWebUtilsAPI } from "./platform/preload-runtime";
...
const glazeAPI = {
  ...
  shell: {
    ...
    // Opens the put.io authorization page in the user's default browser.
